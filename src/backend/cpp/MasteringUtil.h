 ...
 * "output.mp3", "libmp3lame", "Genre", "2025", "Comment" )
 * }
 * @endcode
 */
...
public:
  ...
  public:
    ...
    bool operator==(const Metadata &other) const {
      return ID == other.ID && Title == other.Title && Artist == other.Artist &&
             ...
             Year == other.Year && arguments == other.arguments &&
             Copyright == other.Copyright && Path == other.Path &&
  ...
  public:
    ...
    bool operator==(const Song &other) const {
      return Metadata::operator==(other) && TrackNumber == other.TrackNumber &&
             Codec == other.Codec;
    }
  };
  ...
  public:
    ...
    bool operator==(const Album &other) const {
      return Metadata::operator==(other) && AlbumArt == other.AlbumArt &&
   ...
   */
  void SaveMarkup(const Albums &albums,
