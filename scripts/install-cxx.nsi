!include "x64.nsh"
!define APP_NAME "Daniel's Mastering Utility (C++)"
!define COMP_NAME "Daniel McGuire"
!define VERSION "2.0.0.0"
!define COPYRIGHT "(C) 2025 Daniel McGuire"
!define DESCRIPTION "Mastering Utility 2.0"
!define INSTALLER_NAME "..\dist\masteringutil64_cxx_setup.exe"
!define MAIN_APP_EXE "MasteringWizard-cpp.exe"
...
InstallDir "$PROGRAMFILES64\DanielsMasterer"
...
SetOutPath "$INSTDIR"
file "..\build\MasteringUtility-cpp.exe"
file "..\build\MasteringWizard-cpp.exe"
...
DownloadVC:
  ...
  StrCmp $R0 "0" 0 +2
    MessageBox MB_OK "VC++ Redistributable installation may have failed."
